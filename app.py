...
def generate():
    ...
    width = request.json.get('width')  # Assuming your request structure includes 'width'
    height = request.json.get('height')  # Assuming your request structure includes 'height'

    # Make a request to your FastAPI endpoint
    response = requests.post('http://37.60.173.43:8080/sdapi/v1/txt2img', json={'text': user_text, 'width': width, 'height': height})
